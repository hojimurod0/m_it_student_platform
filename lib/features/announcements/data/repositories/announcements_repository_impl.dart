...
export 'package:m_it_student_platform/features/announcements/domain/repositories/announcements_repository.dart';

class AnnouncementsRepositoryImpl implements AnnouncementsRepository {
  final AnnouncementsRemoteDataSource _dataSource;

  AnnouncementsRepositoryImpl({required AnnouncementsRemoteDataSource dataSource})
      : _dataSource = dataSource;

  @override
  Future<Result<List<Announcement>>> getAnnouncements() async {
    try {
      final models = await _dataSource.getAnnouncements();
      ...
      return FailureResult(UnknownFailure('E\'lonlarni olishda kutilmagan xatolik', e));
    }
  }
}
