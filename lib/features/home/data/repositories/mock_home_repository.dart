...
class MockHomeRepository {
  ...
  static const List<Announcement> announcements = [
    ...
    Announcement(
      id: 'ann-02',
      title: 'Oylik Kurs To\'lovi Eslatmasi (500 000 so\'m)',
      message: 'Hurmatli o\'quvchi, keyingi oy uchun 500 000 so\'m to\'lov 1-Sentyabrgacha qabul qilinadi. To\'lovni Payme, Click yoki kassa orqali amalga oshirishingiz mumkin.',
