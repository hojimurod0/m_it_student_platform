...
class AppColors {
  ...
  static const Color primary = Color(0xFF00213D); // Midnight Tech Navy (#00213D)
  ...
  static const Color primaryAccent = Color(0xFFD3FF32); // Neon Lime Accent (#D3FF32)
  static const Color primaryContainer = Color(0xFFE2EDF8); // Soft Navy Ice Container
  static const Color primarySurface = Color(0xFFF1F6FB); // Ultra Light Slate/Navy Tint
  static const Color brandNavy = Color(0xFF00213D); // Midnight Navy from logo 'm'
  ...
  static const Color accentLime = Color(0xFFD3FF32); // Electric Brand Lime (#D3FF32)
  ...
  // Neutral Dark Palette (Obsidian / Navy Slate)
  static const Color darkBackground = Color(0xFF070E1A); // Deep Obsidian Navy
  static const Color darkSurface = Color(0xFF0F1A2E); // Dark Navy Surface
  static const Color darkSurfaceSecondary = Color(0xFF1E293B); // Slate-800
  static const Color darkSurfaceTertiary = Color(0xFF334155); // Slate-700
  ...
  static const Color textOnPrimary = Colors.white; // Crisp White text on Midnight Navy Primary
